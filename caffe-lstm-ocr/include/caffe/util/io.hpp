...
bool ReadImageToDatum2(const string& filename, const int label,
    const int height, const int width, const bool is_color,
    const std::string & encoding, Datum* datum);

inline bool ReadImageToDatum2(const string& filename, const int label,
    const int height, const int width, const bool is_color, Datum* datum) {
  return ReadImageToDatum2(filename, label, height, width, is_color,
                          "", datum);
}

inline bool ReadImageToDatum2(const string& filename, const int label,
    const int height, const int width, Datum* datum) {
  return ReadImageToDatum2(filename, label, height, width, true, datum);
}

inline bool ReadImageToDatum2(const string& filename, const int label,
    const bool is_color, Datum* datum) {
  return ReadImageToDatum2(filename, label, 0, 0, is_color, datum);
}

inline bool ReadImageToDatum2(const string& filename, const int label,
    Datum* datum) {
  return ReadImageToDatum2(filename, label, 0, 0, true, datum);
}

inline bool ReadImageToDatum2(const string& filename, const int label,
    const std::string & encoding, Datum* datum) {
  return ReadImageToDatum2(filename, label, 0, 0, true, encoding, datum);
}
...
#ifdef USE_OPENCV
cv::Mat ReadImageToCVMat2(const string& filename,
			 const int height, const int width, const bool is_color,
